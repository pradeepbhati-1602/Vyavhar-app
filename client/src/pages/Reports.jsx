        ...
        <div className="overflow-x-auto">
          {loading ? (
            ...
            <table className="w-full border-collapse text-left text-xs">
              ...
              <tbody className="divide-y divide-white/5 text-gray-300">
                {filteredBills.map(b => (
                  <tr key={b.bill_id} className="hover:bg-white/5">
                    <td className="py-3.5 pr-2 font-mono font-bold text-gold">{b.bill_id}</td>
                    <td className="py-3.5 pr-2">
                      <span className="font-bold text-white block leading-tight">{b.customer_name}</span>
                      <span className="text-[10px] text-gray-500 font-mono mt-0.5 block">{b.customer_mobile}</span>
                    </td>
